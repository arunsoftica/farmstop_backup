    ...
    <div class="row mb-5 mt-5">
        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12">
             <div class="xzoom-container">
                <img class="xzoom img-fluid" id="xzoom-default" src="<?php echo base_url('teao/uploads/product_images/'.$prodetail['fimage']) ?>" xoriginal="<?php echo base_url('teao/uploads/product_images/'.$prodetail['fimage']) ?>" />
          <div class="xzoom-thumbs">
              <a href="<?php echo base_url('teao/uploads/product_images/'.$prodetail['fimage']) ?>">
                <img class="xzoom-gallery img-fluid" width="80" height="80" src="<?php echo base_url('teao/uploads/product_images/'.$prodetail['fimage']) ?>"  xpreview="<?php echo base_url('teao/uploads/product_images/'.$prodetail['fimage']) ?>">
            </a>
              <?php
              ...
              ?>
            <a href="<?php echo base_url('teao/uploads/product_images/'.$img['image']) ?>">
                <img class="xzoom-gallery" width="80" src="<?php echo base_url('teao/uploads/product_images/'.$img['image']) ?>"  xpreview="<?php echo base_url('teao/uploads/product_images/'.$img['image']) ?>">
            </a>
                                    ...
                                    <p>
                                    	<select class="select-weight" name="aprice" id="aprice" required>
                                            ...
                                            foreach($vardetail as $vdet){ 
                                             ...
                                             echo '<option value="'.$vdet['regular_price'].'-'.$vdet['sale_price'].'-'.$vdet['weight'].'-'.$vdet['id'].'-'.$vdet['product_attribute_id'].'">'.$vdet['weight'].' Rs.'.$vdet['sale_price'].'</option>';
                                            }

...
<div class="sec-pay">
	<div id="container" style="margin-top:50px; margin-bottom:81px">
       <section id="memo">
            <div class="company-info">
              <span class="company-name" style="margin-top:30px;"><img src="https://cdn.shortpixel.ai/client/to_webp,q_glossy,ret_img/https://www.farmstop.in/assets/images/farmstop.png" width="100" /></span>
              <div class="separator less"></div>
            </div>
            <div class="" style="float: right;margin-top: 42px;margin-right: 25px;">
            <div class="separator"></div>
             <span class="company-address">350, 10th main, Sector-7</span>
                <div class="separator"></div>
              <span > HSR Layout 
    Bengaluru, India - 560078</span>
              <div class="separator"></div>
              <span class="company-email">sales@farmstop.in</span>
              <div class="separator"></div>
              <span class="company-mobile" >+91-8123018988</span>
              <div class="separator"></div>
            </div>
    ...
    line-height: 49px;text-align: center;"><?php if($invoice_details['status'] == 0) echo 'Unpaid'; else echo 'Paid'; ?></span>
       ...
       <section id="invoice-title-number">
            ...
            <?php if(!empty($invoice_details['delivery_date'])){ 
            $dd = explode('/',$invoice_details['delivery_date']);
            $dd = $dd[2].'-'.$dd[1].'-'.$dd[0];
            ?>
            <div class="separator"></div>
            <span>Delivery Date: <?php echo date("l dS F,Y", strtotime($dd)); ?></span>
            <?php } ?>
       ...
       <section id="items-success">
          ...
          ?>
            ...
            <td><span><?php echo $saleprice*$get_cart_item['total_item'] ?></span></td>
              </tr>
              <?php } ?>
            </tbody></table>
       </section>

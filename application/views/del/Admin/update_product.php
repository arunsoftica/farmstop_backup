...
<div class="row" >
  ...
  <?php if($feedback=$this->session->flashdata('feedback')): ?>
    ...
    <div class="row">
    <div class="col-lg-12">
    <form role="form" id="update_product" enctype="multipart/form-data" method="post">

    
   <input type="hidden" name="pro_id" value="<?php echo $products['id'] ?>">
	 <div class="row">
   <div class="form-group col-md-8">
   <h4>Product Title</h4>
   <input type="text" name="pro_title" value="<?php echo $products['title'] ?>" class="form-control" >
   </div>
   ...
   <div class="row">
    ...
    foreach($images as $img){ ?>
     ...
     <img src="<?php echo base_url('uploads/product_images/'.$img['image']) ?>" height="200" width="200"><button type="button" class="btn btn-default delimg" value="<?php echo $img['id'] ?>"><i class="fa fa-trash" aria-hidden="true"></i></button>
    </div>

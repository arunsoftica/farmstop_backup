...
function mobileNumberValidate(value,elementName,errMsgMobile,disableElement){
	//alert(value);
  ...
  if(value != ""){
	  if(value.match(phoneno)) {
		 ...
		 document.getElementById(errMsgMobile).innerHTML = "<span style='color:red;'>Invalid "+ elementName +" Number.</span>";;
	     document.getElementById(disableElement).disabled = true;
		 return false;
	   }
  }
  else{
     document.getElementById(errMsgMobile).innerHTML = "<span style='color:red;'>"+ elementName +" Number is required.</span>";
     document.getElementById(disableElement).disabled = true;
	 return false;
  }
}
...
function emailValidate(value,elementName,errMsgEmail,disableElement){
   ...
   var emailFix = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/;
    if(value != ""){
		  if(emailFix.test(value)) {
			 ...
			 document.getElementById(errMsgEmail).innerHTML = "<span style='color:red;'>You have entered an invalid "+ elementName +" address.</span>";
			 document.getElementById(disableElement).disabled = true;
			 return false;
		   } 
		}
	  else{
		  document.getElementById(errMsgEmail).innerHTML = "<span style='color:red;'>"+ elementName +" field is Required</span>"; 
		  document.getElementById(disableElement).disabled = true;
		  return false;
		} 	 
 }

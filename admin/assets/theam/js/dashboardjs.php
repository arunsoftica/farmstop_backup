...
(function($) {
  ...
  $(function() {
      var orderByLocationData = {
        datasets: [{
            data: ["<?php echo $north_order['total_order'] ?>", "<?php echo $east_order['total_order'] ?>", "<?php echo $west_order['total_order'] ?>", "<?php echo $south_order['total_order'] ?>"],
            backgroundColor: [
                '#5d78ff',
                '#ffb61b',
                '#2cd9c5',
      ...
      var saleByLocationData = {
        datasets: [{
            data: [<?php echo number_format(($north_order['total_order']/$order_sales['total_order'])*100,2) ?>, <?php echo number_format(($east_order['total_order']/$order_sales['total_order'])*100,2) ?>, <?php echo number_format(($west_order['total_order']/$order_sales['total_order'])*100,2) ?>, <?php echo number_format(($south_order['total_order']/$order_sales['total_order'])*100,2) ?>],
            backgroundColor: [
                '#fc3995',
                '#5d78ff',
                '#ffb720',

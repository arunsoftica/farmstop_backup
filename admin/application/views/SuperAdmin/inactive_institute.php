...
<div class="row" >
  ...
  <?php if($feedback=$this->session->flashdata('feedback')): ?>
                       ...
                       <center><h3><?php echo $feedback; ?></h3></center> 
                        ...
                        <?php endif; ?>
  <div class="col-lg-12">
        <h2 class="page-header">Inactive Admin/Institute</h2>
        <?php //echo $title; ?>
    </div>
  <div class="row" >
    <div class="col-lg-12" >
      ...
      <?php 
        ...
        foreach($admin as $adm){ ?>
         <tr>
           ...
           <td><a href="<?php echo base_url('superadmin/inactive_institute?admact='.$adm['id']) ?>">Active</a></td>
           <td><?php echo $adm['institute_name']; ?></td>

...
<div id="container">
      ...
      <section id="memo">
        ...
        <div class="company-info">
          <span class="company-name"><img src="https://cdn.shortpixel.ai/client/to_webp,q_glossy,ret_img/https://www.farmstop.in/assets/images/farmstop.png" width="100" /></span>
          <div class="separator less"></div>

          <span class="company-address">1229, 4th Cross, Sector 7, HSR Layout, Bengaluru</span>
          <span >India - 560038</span>

          <br>

          <span class="company-email">Email:  sales@farmstop.in</span><br>
          <span class="company-mobile" >Mobile:  +91-8123018988</span>
        </div>
      ...
      <section id="items">
        ...
        <table class="table-responsive" cellpadding="0" cellspacing="0">
          ...
          <tr data-iterate="item" style="">
            ...
            <td><span>
                <?php echo $saleprice*$get_cart_item['total_item'] ?>

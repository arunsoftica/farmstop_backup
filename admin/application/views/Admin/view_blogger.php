<div class="content-wrapper">
  ...
  <?php if($feedback=$this->session->flashdata('feedback')): ?>
                       ...
                       <center><h3><?php echo $feedback; ?></h3></center> 
                        ...
                        <?php endif; ?>
    				<h4 class="card-title">View Blogger</h4>
      ...
      <?php 
        ...
        foreach($blogger as $mod){ ?>
         <tr>
           ...
           <td><a href="<?php echo base_url('update_blogger?upblg='.$mod['id']) ?>">Edit</a>/<a onclick="return confirm('Are you sure?');" href="<?php echo base_url('view_blogger?delblg='.$mod['id']) ?>">Delete</a></td>

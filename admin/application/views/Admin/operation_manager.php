...
<div class="content-wrapper">
  ...
  <?php if($feedback=$this->session->flashdata('feedback')): ?>
                       ...
                       <center><h3><?php echo $feedback; ?></h3></center> 
                        ...
                        <?php endif; ?>
    				<h4 class="card-title">Add Operation Manager</h4>
   ...
   <div class="form-group col-md-4">
   <h4>Mobile</h4>
   <input type="number" maxlength="10" name="mobile" value="<?php echo set_value('mobile'); ?>" class="form-control" required>
   </div>
   <div class="form-group col-md-4">
    <h4>Email</h4>
   ...
   <textarea name="address" value="<?php echo set_value('address'); ?>" class="form-control" required></textarea>
   ...
   <div class="form-group col-md-6">
    <h4>Gender</h4>
    <input type="radio" name="gender" id="male" checked value="m"> Male

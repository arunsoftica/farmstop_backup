...
<div class="row" >
  ...
  <?php if($feedback=$this->session->flashdata('feedback')): ?>
                       ...
                       <center><h3><?php echo $feedback; ?></h3></center> 
                        ...
                        <?php endif; ?>
    <div class="col-lg-12">
        <h1 class="page-header">Student Fees Report</h1>
        <?php //echo $title; ?>
    </div>
    <div class="row" >
    <div class="col-lg-12" >
    ...
    <div class="row">
    <div class="col-lg-12">
    <form role="form" id="fees_report" method="post">
...
$(document).on('submit','#fees_report',(function(e){
 
    e.preventDefault();
      $.ajax({
      url: "Ajaxcontroller/student_fees_report",
      type: "POST",        

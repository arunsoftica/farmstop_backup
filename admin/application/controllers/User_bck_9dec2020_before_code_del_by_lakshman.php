...
public function inventory_report_by_product(){
 ...
 public function add_student(){
  ...
  $this->form_validation->set_rules('time1', 'Select Time', 'required');
  $this->form_validation->set_rules('time2', 'Select Time', 'required');
   if( $this->form_validation->run() == true){
   	  $result = $this->Adminmodel->add_student();
   	  //echo "<pre>";
   	  //print_r($result);exit;
   	  if($result)
      {
        $this->session->set_flashdata('feedback','Student Added Successfully');
        //$this->session->set_flashdata('feedback_class','alert-success');
        return redirect('student');
      }
      else
      {
      	$this->session->set_flashdata('feedback','Student Failed to Add, Please Try Again..');
 ...
 if( $this->form_validation->run() == true){
      ...
      if($res['inst_tbl_id'] != False){
         ...
         $result = $this->Adminmodel->add_class($inst_tbl['id']);
      if($result)
      {
        $this->session->set_flashdata('feedback','Class Added Successfully');
        
        return redirect('view_class');
      }
      else
      {
        $this->session->set_flashdata('feedback','Class Failed to Add, Please Try Again..');
 ...
 public function update_class(){
  $this->form_validation->set_rules('class_name', 'Class', 'trim|required');
   if( $this->form_validation->run() == true){
    //print_r($_POST);exit;
    $result = $this->Adminmodel->update_class();
    if($result != FALSE){
       $this->session->set_flashdata('feedback','Class Updated Successfully');
 ...
 public function update_subject(){
  ...
  if( $this->form_validation->run() == true){
    //print_r($_POST);exit;
    $result = $this->Adminmodel->update_subject();
    if($result != FALSE){
       $this->session->set_flashdata('feedback','Subject Updated Successfully');
 ...
 public function delete_class(){
    ...
    $result = $this->Adminmodel->delete_class($_GET['delcid']);
    if($result != FALSE){
      $this->session->set_flashdata('feedback','Class Deleted Successfully');
 ...
 public function delete_subject(){
    //print_r($_GET['delcid']);exit;
    $result = $this->Adminmodel->delete_subject($_GET['delsub']);
    if($result != FALSE){
      $this->session->set_flashdata('feedback','Subject Deleted Successfully');
 ...
 public function delete_student(){
    //print_r($_GET['delcid']);exit;
    $result = $this->Adminmodel->delete_student($_GET['delstu']);
    if($result != FALSE){
      $this->session->set_flashdata('feedback','Student Deleted Successfully');
 ...
 public function active_student(){
    //print_r($_GET['delcid']);exit;
    $result = $this->Adminmodel->active_student($_GET['instu']);
    if($result != FALSE){
      $this->session->set_flashdata('feedback','Student Activated Successfully');
        
       return redirect('inactive_student');
    }
 }
 public function delete_teacher(){
    //print_r($_GET['delcid']);exit;
    $result = $this->Adminmodel->delete_teacher($_GET['deltea']);
    if($result != FALSE){
      $this->session->set_flashdata('feedback','Teacher Deleted Successfully');
 ...
 public function active_teacher(){
    //print_r($_GET['delcid']);exit;
    $result = $this->Adminmodel->active_teacher($_GET['intea']);
    if($result != FALSE){
      $this->session->set_flashdata('feedback','Teacher Active Successfully');
        
       return redirect('inactive_teacher');
    }
 }
 public function delete_student_import(){
    //print_r($_GET['delcid']);exit;
    $result = $this->Adminmodel->delete_student_import($_GET['delstuy']);
    if($result != FALSE){
      $this->session->set_flashdata('feedback','Student Deleted Successfully');
 ...
 public function delete_teacher_import(){
    //print_r($_GET['delcid']);exit;
    $result = $this->Adminmodel->delete_teacher_import($_GET['delteay']);
    if($result != FALSE){
      $this->session->set_flashdata('feedback','Teacher Deleted Successfully');
